...
| ADR-006 | [Schema Hash Pinning for Write Clients](./ADR-006-schema-hash-pinning-for-write-clients.md) | 6.12            |
...
- ADR-006 records the schema hash pinning decision applied in `docs/specs/SPEC-008-cli-and-sdk.md` for write clients.
