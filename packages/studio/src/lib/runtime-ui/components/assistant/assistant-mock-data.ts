...
const PROPOSALS: Record<string, AssistantProposal> = {
  ...
  "p-batch-locale": {
    proposalId: "p-batch-locale",
    kind: "batch",
    summary: "Seed Polish drafts from 4 English source docs",
    validation: { status: "valid" },
    expiresAt: "2026-05-07T10:24:00Z",
    children: [
      {
      ...
      },
      {
        ...
        preview: "{ enabled: ['en', 'pl'], default: 'en' }",
      },
    ],
  },
};
